...
900 seconds) bounds replay GPU memory. The current demo set includes 20 cases
and intentionally excludes PriMock57 cases 01, 09, and 10; `scripts/m2-verify.sh`
defaults to case 02.
