 ...
 *
 * The browser does not call this class directly; it runs when Symfony proxies
 * history or role snapshot requests to Python. The tests assert the header and log fields
 * that let operators join that proxy call to FastAPI logs.
 */
