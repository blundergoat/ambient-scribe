#!/usr/bin/env bash
# =============================================================================
# Terraform Helper Script - ambient-scribe
# =============================================================================
#
# Simplifies common Terraform operations for the ambient-scribe agent.
#
# USAGE:
...
show_help() {
    echo -e "${BOLD}${BLUE}Terraform Helper Script - ambient-scribe${NC}"
    echo ""
