...
|---|-------------------------------------------------|---|-----------------------------------------|
| 1 | Who is speaking right now                       | NVIDIA Streaming Sortformer - `nvidia/diar_streaming_sortformer_4spk-v2.1` | local machine GPU, live while recording |
| 2 | What is being said, live                        | NVIDIA Multitalker Parakeet 0.6B - `nvidia/multitalker-parakeet-streaming-0.6b-v1` | local GPU, live                        |
...
| 6 | Fix commonly misheard drug and condition names  | Not a model - curated lookup file `strands_agents/data/medical_lexicon.txt` | local CPU, live                        |
